...
| 10. Coverage Matrix Page | 0/9 | 🚧 Planning complete (9 plans, 6 waves; v1.1 milestone; migration 0008; replanned 2026-05-13 via /gsd-plan-phase --reviews) | - |
...
**Plans:** 9 plans (Wave 0 → 6; replanned 2026-05-13 from cross-AI review feedback in 10-REVIEWS.md)
...
- [ ] 10-08-PLAN.md — Wave 5: Migration 0008 + ADR 0021 in claude-workflow repo (human-action checkpoints) + dashboard-side migration-0008.fixture.test.ts (CI-resident per CODEX MED-17) + migration-0008.smoke.test.ts (cross-repo, warns-not-skips) + CHANGELOG.md v1.1 entry (COV-12 + workflow head 1.7.0 → 1.8.0)
