...
- **Anti-AI-slop self-test:** the dashboard's own UI must pass `impeccable:critique` ≥ 90.
...
15. The dashboard's own UI passes `impeccable:critique` ≥ 90.
...
- **Anti-AI-slop self-test.** The dashboard's own UI passes `impeccable:critique` ≥ 90.
